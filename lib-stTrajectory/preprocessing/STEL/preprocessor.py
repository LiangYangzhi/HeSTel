...
class Preprocessor(object):
    ...
    def loader(self):
        ...
        data1 = data[['tid', 'time', 'lat', 'lon', 'did']]
        data2 = data[['tid', 'm_time', 'm_lat', 'm_lon', 'm_did']]
        data2 = data2.rename(columns={'m_time': 'time', 'm_lat': 'lat', 'm_lon': 'lon', 'm_did': 'did'})
    ...
    def ts2vector(self):
        logging.info("time segment and space coordinate of vector...")
        ...
        self.data1.info(buf=buffer)
        logging.info(f"data1 info after time segment: {buffer.getvalue()}")
        logging.info("time segment and space coordinate of vector completed")
    ...
    def st2vector(self):
        logging.info("space segment and time coordinate of vector...")
        sseg = self.data2.sseg.unique().tolist()
        ...
        self.data2.info(buf=buffer)
        logging.info(f"data2 info after time coordinate: {buffer.getvalue()}")
        logging.info("space segment and time coordinate of vector completed")
    ...
    def run(self):
        ...
        self.ts2vector()  # time segment and space coordinate of vector
        # Passive
        self.sseg()  # space segment
        self.tcoor()  # time coordinate
        self.st2vector()  # space segment and time coordinate of vector
