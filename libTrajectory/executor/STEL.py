...
class Executor(object):
    ...
    def train(self, train_data, ts_vec, st_vec, out_dim=256, epoch_num=10, batch_size=64, num_workers=0):
        ...
        for epoch in range(epoch_num):  # 每个epoch循环
            ...
            for batch_tid in data_loader:  # 每个批次循环
                ...
                # cosine_sim2 = F.cosine_similarity(user1.unsqueeze(1), node2[: batch_size], dim=2)
                # cosine_sim3 = F.cosine_similarity(user2.unsqueeze(1), node1[: batch_size], dim=2)
