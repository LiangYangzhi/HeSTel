...
class Preprocessor(AbstractPreprocessor):
    ...
    def data_loading(self, sample):
        ...
        self.data1 = data_loader.get_data(start_time=start_time, end_time=end_time, **self.config['data1'])
        self.col1 = self.config['data1']['columns']
        self.data2 = data_loader.get_data(start_time=start_time, end_time=end_time, **self.config['data2'])
        ...
        if "label" in self.config:
            ...
            label_user1 = self.label[self.col1['user']].unique().tolist()
    ...
    def get_data(self):
        return self.feature, self.col_feature, self.label
